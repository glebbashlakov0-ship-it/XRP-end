          ...
          <div className="space-y-6 min-w-0">
            <div>
              ...
              <p className="mt-1 text-sm text-gray-600">
                Update the Terms of Service content shown on the public site.
              </p>
            </div>
            ...
            <form
              ...
              action={async (formData) => {
                ...
                await prisma.siteContent.upsert({
                  where: { key: TERMS_INTRO_KEY },
                  update: { value: nextIntro },
                  create: { key: TERMS_INTRO_KEY, value: nextIntro },
                });

                await prisma.siteContent.upsert({
                  where: { key: TERMS_BODY_KEY },
                  update: { value: nextBody },
                  create: { key: TERMS_BODY_KEY, value: nextBody },
                });
            ...
            >
              ...
              <label className="grid gap-2 text-sm">
                <span className="font-medium text-gray-700">Terms body</span>
                <textarea
                  name="body"
                  defaultValue={body}
